...
with gzip.open("train/train.article.txt.gz", "rb") as gz:
    with open("train/train.article.txt", "wb") as out:
        out.write(gz.read())

with gzip.open("train/train.title.txt.gz", "rb") as gz:
    with open("train/train.title.txt", "wb") as out:
        out.write(gz.read())
