...
class Skipgram(object):
	...
	def train(self):
		...
		scores = tf.squeeze(tf.matmul(embed_u, embed_v_trans), [2])   		# batch_size x 1
		norm_scores = tf.squeeze(tf.matmul(embed_actual, embed_v_trans), [2])  # batch_size x input_size
