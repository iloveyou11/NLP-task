...
base_path = '/Users/yangpei/Documents/code/AI/my-nlp-task/text_classify_all/text_classify_news/'
...
def get_text(item):
    ...
    for files in filelist:
        ...
        data1 = ''.join(re.findall(u'[\u4e00-\u9fff]+', text))  # 必须为unicode类型，取出所有中文字符
        data2 = jieba.cut(data1.encode('utf-8'))  # 分词
